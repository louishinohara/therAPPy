...
export default class CapsSurvey11 extends Component {
    state = {
        q51: -1,
        q52: -1,
        q53: -1,
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.loginText}>Questions: 51-55 / 62</Text>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        ...
                        this.props.navigation.navigate('CapsSurvey12Screen')}}>
                    <Text style={styles.loginText}>To questions 56-60</Text>
                </TouchableOpacity>
            </View>
        );
    }
